...
**Видео (35 с):** живой прогон на демо — вход, чат по номеру, отправка в MAX, ответ получателя
из приложения MAX на телефоне. Ожидание ответа (~7 минут) вырезано.
[docs/demo.mp4](docs/demo.mp4)

![Живой прогон: отправка сообщения и ответ получателя из MAX](docs/demo.gif)

| Чат                               | Вход                                | Телефон                                 |
| --------------------------------- | ----------------------------------- | --------------------------------------- |
| ![Чат](docs/screenshots/chat.png) | ![Вход](docs/screenshots/login.png) | ![Телефон](docs/screenshots/mobile.png) |
